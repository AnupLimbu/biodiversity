    ...
    <div class="navbar-filler" style="background-color: #abcea0;">
        ...
        <section class="container mx-auto  max-w-screen-xl bg-white ">
            <section class="bg-white ">
                ...
                @endif
                    @if($staff->count()>0)
                        <div class="px-2 mx-auto max-w-screen-xl text-center lg:px-6 {{$advisor->count()>0||$volunteer->count()>0?'':"min-h-[100vh]"}}" >
                            <div class="mx-auto mb-1 max-w-screen-sm lg:mb-16">
               ...
               @if($volunteer->count()>0)
                        <div class="px-2 mx-auto max-w-screen-xl text-center lg:px-6 {{$staff->count()>0||$advisor->count()>0?'':"min-h-[100vh]"}}" >
                            <div class="mx-auto mb-1 max-w-screen-sm lg:mb-16">

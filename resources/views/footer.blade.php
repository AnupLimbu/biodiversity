...
<div class="pt-16 container mx-auto p-2 ">
    <div class="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="space-y-2 text-[14px]">
            ...
            <div class="flex">
                ...
                <a href="tel:+977-9808840764" aria-label="Our phone" title="Our phone" class="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">+977-9808840764</a>
            </div>
            <div class="flex">
        ...
        <div>
            ...
            <div class="flex items-center mt-1 space-x-3">
                <a href="https://www.facebook.com/BRCSociety" target="_blank" class="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
    ...
    <div class="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
        <p class="text-[14px] text-gray-600">
            © Copyright 2024 BRCS. All rights reserved.
        </p>
        <ul class="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
{{--            <li>--}}
{{--                <a href="/" class="text-[14px] text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">F.A.Q</a>--}}
{{--            </li>--}}
{{--            <li>--}}
{{--                <a href="/" class="text-[14px] text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">Privacy Policy</a>--}}
{{--            </li>--}}
{{--            <li>--}}
{{--                <a href="/" class="text-[14px] text-gray-600 transition-colors duration-300 hover:text-deep-purple-accent-400">Terms &amp; Conditions</a>--}}
{{--            </li>--}}
        </ul>
    </div>
</div>
